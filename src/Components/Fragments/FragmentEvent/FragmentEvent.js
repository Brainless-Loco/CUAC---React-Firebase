        ...
        return (
            <div className="FragmentEvent" ref={this.props.nodeRef}>
                ...
                <div className="EventDetails p-2">
                    ...
                    <h2 className="h4 text-white mb-1">{this.data.title}</h2>
                    <small className="text-white"><i class="fas h5 mb-0 fa-calendar-alt"></i> {new Date(this.data.happeningAt).toDateString()} </small>
                    {/* Manipulate the details markup. */}
                    <div className="text-left mb-1 text-white"> 
                        {this.data.detailsMarkup}
                    </div>
                    ...
                    <Dialog className="Eventdialogue" fullScreen open={this.state.open} onClose={()=>this.setState({open: false})} TransitionComponent={Transition}>
                        <AppBar className="d-flex p-2 justify-content-between Appbar">
                            <Toolbar>
                                ...
                                <butoon className="ml-auto p-4" onClick={()=>this.setState({open: false})}>
                        ...
                        <div className="content">
                            ...
                            <div className="col-md-7 float-left">
                                <h2 className="h2 my-0 title text-color1">{this.data.title}</h2>
