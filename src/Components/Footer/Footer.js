        ...
        <div className="footerDiv text-white">
            <div className="row text-center mt-4">
                ...
                <div className="col-md-5 mx-auto px-md-5 mt-4 text-left float-left">
                    ...
                    <a href="http://" className="footerLinks" target="_blank" rel="noopener noreferrer"><i class="fas fa-at"></i> Email</a>
                    <a href="http://" className="footerLinks" target="_blank" rel="noopener noreferrer"><i class="fab fa-youtube"></i> Youtube</a>
                    <a href="http://" className="footerLinks" target="_blank" rel="noopener noreferrer"><i class="fab fa-facebook-square"></i> Facebook Page</a>
                    <a href="http://" className="footerLinks" target="_blank" rel="noopener noreferrer"><i class="fas fa-users"></i> Facebook Community</a>
                </div>
            </div>
        </div>
    );
